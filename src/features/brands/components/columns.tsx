...
export const columns: ColumnDef<Brandtype>[] = [
      ...
      <div className="flex items-center gap-3">
        <Avatar className="h-12 w-12 rounded-lg border-2 border-muted">
          ...
          <AvatarFallback className="rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 text-white font-bold text-lg">
            {row.original.name?.charAt(0).toUpperCase() || 'B'}
          </AvatarFallback>
        </Avatar>
...

  {
    ...
    /*************  ✨ Windsurf Command ⭐  *************/
    /**
     * Renders the header for the "Status" column in the data table.
     * Utilizes the DataTableColumnHeader component to display
     * the column title with sorting capabilities.
     *
     * @param {Object} props - The properties object.
     * @param {Column} props.column - The column instance for which the header is being rendered.
     */

    /*******  04cf993f-6768-4894-be5d-d5d95fd0fd9b  *******/
    header: ({ column }) => (
